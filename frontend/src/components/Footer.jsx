...
export default function Footer() {
  ...
  const socialLinks = Array.isArray(contactData?.social_links) ? contactData.social_links : [];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'var(--theme-text-secondary)' }}>
              {contactData?.bio_tagline || 'Guiding the future, one line at a time. Passionate about Cloud, DevOps, automation, and building high-performance software systems.'}
            </p>
            {/* Social Links */}
